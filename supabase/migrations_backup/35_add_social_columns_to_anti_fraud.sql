...
CREATE INDEX idx_anti_fraud_instagram ON anti_fraud(instagram) WHERE instagram IS NOT NULL;
CREATE INDEX idx_anti_fraud_tiktok ON anti_fraud(tiktok) WHERE tiktok IS NOT NULL;
