			...
			<div class="rounded-lg border bg-card p-6">
				...
				<div class="space-y-3">
					<div class="flex items-start gap-2">
						...
						<span class="font-normal">{data.orderData.customer_name}</span>
					</div>
					<div class="flex items-start gap-2">
						<span class="text-muted-foreground">Email :</span>
						<span class="break-all font-normal"
							>{data.orderData.customer_email}</span
						>
					</div>
					{#if data.orderData.customer_phone}
						<div class="flex items-start gap-2">
							<span class="text-muted-foreground">Téléphone :</span>
							<span class="font-normal">{data.orderData.customer_phone}</span>
						</div>
					{/if}
					{#if data.orderData.customer_instagram}
						<div class="flex items-start gap-2">
							...
							<span class="font-normal"
								>@{data.orderData.customer_instagram}</span
							>
						</div>
					{/if}
				</div>
			...
			<div class="rounded-lg border bg-card p-6">
				...
				<div class="space-y-4">
					...
					<div class="flex items-center justify-between">
						...
						<span class="font-normal">{data.product.name}</span>
					</div>
					...
					<div class="flex items-center justify-between">
						...
						<span class="font-normal"
							>{formatPrice(data.product.base_price)}</span
						>
					</div>
					...
					<div class="border-t pt-4">
						...
						<div class="mb-2 flex items-center justify-between">
							...
							<span class="font-normal"
								>{formatPrice(data.orderData.total_amount)}</span
							>
						</div>
