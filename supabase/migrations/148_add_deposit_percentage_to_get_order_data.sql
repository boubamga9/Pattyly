-- Migration: Add deposit_percentage to product object in get_order_data function
-- Description: Add deposit_percentage to product object so it can be displayed on product detail page
...
COMMENT ON FUNCTION get_order_data(TEXT, UUID) IS 'Get order data including deposit_percentage for products';
