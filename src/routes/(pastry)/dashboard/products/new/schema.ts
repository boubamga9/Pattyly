import { z } from 'zod';
import { createProductSchema } from '$lib/validations/schemas/product.js';
import { customizationFieldSchema } from '$lib/validations/schemas/form.js';

// Schéma pour la création de produit avec champs de personnalisation
export const createProductFormSchema = createProductSchema.omit({
    form_id: true // On ne l'a pas dans le formulaire, il sera créé côté serveur
}).extend({
