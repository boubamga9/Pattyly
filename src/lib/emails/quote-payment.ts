    ...
    return `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="margin-bottom: 16px;">
                <h2 style="color: #f97316; margin-top: 0; font-size: 18px; font-weight: normal;">💳 Paiement reçu !</h2>
                <p>Le client ${customerName} a accepté votre devis et effectué le paiement de l'acompte.</p>
                <p style="margin-bottom: 24px;">Vous pouvez maintenant commencer la préparation de son gâteau.</p>
            </div>
            ...
            <div style="background-color: #f8f9fa; padding: 16px; border-radius: 6px; margin: 16px 0;">
                <h3 style="margin-top: 0; color: #333; font-size: 16px; font-weight: bold;">💰 Détail financier</h3>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600;">Prix total :</td>
                        <td style="padding: 8px 0; text-align: right;"><strong>${totalPrice}€</strong></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600;">Acompte reçu :</td>
                        <td style="padding: 8px 0; text-align: right;"><strong style="color: #28a745;">${depositAmount}€</strong></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600;">Solde restant :</td>
                        <td style="padding: 8px 0; text-align: right;"><strong style="color: #dc3545;">${remainingAmount}€</strong></td>
                    </tr>
                </table>
            </div>
